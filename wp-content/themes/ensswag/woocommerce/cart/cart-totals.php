    ...
    <div class="shop_table shop_table_responsive">
        ...
        <div class="cart-subtotal">
            <div class="cart-subtotal-title">
                <div class="subtotal-title"><?php esc_html_e('Subtotal', 'woocommerce'); ?>: <div data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>"><?php wc_cart_totals_subtotal_html(); ?></div></div>
