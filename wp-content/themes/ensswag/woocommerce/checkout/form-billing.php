...
<div class="woocommerce-billing-fields">
    ...
    <div class="woocommerce-billing-fields__field-wrapper">
        ...
        echo '<h4 class="form-row form-row-wide first-h4"><span>' . __('Personal Information', 'woocommerce') . '</span></h4>';
        ...
        foreach ($fields as $key => $field) {
            ...
            if ($key === 'billing_email') {
                echo '<h4 class="form-row form-row-wide first-h4"><span>' . __('Shipping Information', 'woocommerce') . '</span></h4>';
            }
